...
class AppColors {
  ...
  static const textPrimary = Color(0xFF1E1E1E); /// Main title text
  static const textSecondary = Color(0xFF9E9E9E); /// Subtitles and descriptions
  static const accentPink = Color(0xFFFF6B6B); /// For progress indicators / alerts
  static const accentGreen = Color(0xFF49F988); /// For Background effects
  static const accentPurple = Color(0xFF9D00FC);
  static const accentTeal = Color(0xFF00B2A9);
  static const accentOrange = Color(0xFFFFA500);   /// For progress indicators / alerts
